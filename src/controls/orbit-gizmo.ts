...
export class OrbitControlsGizmo {
    ...
    constructor(
        ...
        type Axis = ReturnType<typeof createAxes>[number];
        ...
        function drawCircle(p: { x: number; y: number }, radius = 10, color = '#FF0000') {
            context.beginPath();
        ...
        function drawLine(p1: { x: number; y: number }, p2: { x: number; y: number }, width = 1, color = '#FF0000') {
            context.beginPath();
        ...
        function setAxisPosition(axis: Axis) {
